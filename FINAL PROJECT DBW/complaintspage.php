...
<div id="signup-box"><div class="signup"><center>
  ...
  <input type="textarea" name="address" placeholder="address"required/>
    ...
    <option value="Animal Welfare">TRUST ISSUES</option>
    <option value="Blood Donation">FOOD QUALITY</option>
    <option value="Child Labour">SUPPORT ISSUE</option>
    <option value="Climate Change">LABOUR</option>
		<option value="Crime Against Women">MONEY</option>
				<option value="Cyber Crime">ENTERTAINMENT</option>
						<option value="Education">HYGINE</option>
								<option value="Health Care">TOILETS</option>
										<option value="Sexual Harassment">MISSING</option>
												<option value="Waste Managemant">CLEANLINESS</option>
